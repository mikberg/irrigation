...
def go_dependencies():
    ...
    Update with:
        bazel run gazelle -- update-repos -from_file=go.mod -prune -to_macro third-party/go/deps.bzl%go_dependencies
    ...
    go_repository(
        ...
        sum = "h1:9HKGCsdJqE4dnrQ8VerFS0/1ZOJPmAhN+g8xgp8y3K4=",
        version = "v1.3.13",
    )
    ...
    go_repository(
        ...
        sum = "h1:03fqBEEgivp4MVK2ElB140B56hjO9ZFvFTHBsvFsSro=",
        version = "v0.13.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:082jdJ5t1CFeo0rpGQvKAK1mONVSbFhL4finWA5bRM8=",
        version = "v2.2.3",
    )
    go_repository(
